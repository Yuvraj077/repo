# 🌾 Khet2Tech | Smart India Hackathon 2026 (SIH26033)
...
[![KHET2TECH](https://img.shields.io/badge/KHET2TECH%20Cells-orange?style=for-the-badge&logo=target)](https://github.com/eshaansharma07/khet2tech-sih2026)
[![Vercel Deployment](https://img.shields.io/badge/Live%20Demo-Vercel-success?style=for-the-badge&logo=vercel)](https://khet2tech-sih2026.vercel.app)
[![GitHub Repository](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github)](https://github.com/Yuvraj077/khet2tech-sih2026)
...
| **Category** | Software |
| **Live Production URL** | **[https://khet2tech-sih2026.vercel.app](https://khet2tech-sih2026.vercel.app)** |
| **Source Code Repository** | **[https://github.com/Yuvraj077/khet2tech-sih2026](https://github.com/eshaansharma07/khet2tech-sih2026)** |
...
## 💡 The Solution: Khet2Tech

**Khet2Tech is NOT just another digital marketplace.** 

Instead of expecting smallholder farmers to navigate complex bidding apps, Khet2Tech models the entire regional agricultural trade network as an **intelligent, constrained decision graph**. It computes:
...
> **Note for Evaluators**: The values below represent the deterministic output calculated live by the Khet2Tech graph solver for a standard 5,000 kg tomato harvest lot at baseline conditions (₹95/L fuel, 30°C temperature). You can test any crop, quantity, or weather condition interactively on the [Live Simulator](https://khet2tech-sih2026.vercel.app/simulator).

| Metric | Option A: Conventional APMC Mandi | Option B: Khet2Tech Intelligent Direct Route | Impact / Gain |
| :--- | :--- | :--- | :--- |
...
Khet2Tech delivers **100% deterministic, explainable calculations** with zero hardcoded UI illusions.
...
```mermaid
graph TD
    A["Farmer / FPO Input Lot"] --> B["Khet2Tech Engine"]
...
│   │   ├── Footer.tsx                   # Official SIH & Team KHET2TECH footer
...
```bash
git clone https://github.com/Yuvraj077/khet2tech-sih2026.git
cd khet2tech-sih2026
```
...
```env
MONGODB_URI=mongodb+srv://<username>:<password>@cluster0.arnquds.mongodb.net/khet2tech?retryWrites=true&w=majority
```
...
| Evaluation Pillar | How Khet2Tech Fulfills It |
| :--- | :--- |
