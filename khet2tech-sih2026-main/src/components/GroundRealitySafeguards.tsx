    ...
    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              How Khet2Tech solves the dirty, real-world operational challenges of Indian agriculture:
            </p>
          </div>
        </div>
      </div>
      ...
      {activePillar === 'quality' && (
        <div className="p-5 rounded-2xl bg-emerald-50/70 border border-emerald-200 space-y-4 animate-in fade-in duration-200">
          ...
          <p className="text-xs text-slate-700 leading-relaxed">
            In traditional trades, buyers reject shipments arbitrarily or deduct arbitrary 20% quality penalties. Khet2Tech prevents this through <strong>Pre-Dispatch Digital Assaying</strong> at local collection hubs:
          </p>
      ...
      {activePillar === 'legal' && (
        <div className="p-5 rounded-2xl bg-blue-50/70 border border-blue-200 space-y-4 animate-in fade-in duration-200">
          ...
          <p className="text-xs text-slate-700 leading-relaxed">
            Khet2Tech operates strictly within the existing statutory framework of state APMC reforms and central farmer-support policies:
          </p>
      ...
      {activePillar === 'logistics' && (
        <div className="p-5 rounded-2xl bg-purple-50/70 border border-purple-200 space-y-4 animate-in fade-in duration-200">
          ...
          <p className="text-xs text-slate-700 leading-relaxed">
            Khet2Tech connects into existing rural transport ecosystems rather than attempting to buy expensive truck fleets:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
      ...
      {activePillar === 'data' && (
        <div className="p-5 rounded-2xl bg-amber-50/70 border border-amber-200 space-y-4 animate-in fade-in duration-200">
          ...
          <p className="text-xs text-slate-700 leading-relaxed">
            How Khet2Tech handles live data feeds across India without getting blocked by slow government servers:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
