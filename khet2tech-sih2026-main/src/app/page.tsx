...
export default function ControlCenter() {
  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-slate-850 to-emerald-950 text-white rounded-3xl p-6 sm:p-8 shadow-md border border-slate-800 space-y-6 relative overflow-hidden">
        ...
        <div className="space-y-3 max-w-4xl">
          <h1 className="text-2xl sm:text-4xl font-black tracking-tight text-white leading-tight">
            Khet2Tech <span className="text-emerald-400">|</span> &ldquo;{t.tagline}&rdquo;
          </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-white font-bold">
                {cropLot.crop} • {formatINR(cropLot.quantityKg)} kg (Farmer: {cropLot.farmerName})
              </span>
            </div>
          </div>
      ...
      {/* 2. Interactive Farmer Dispatch & Lot Registration Wizard */}
      <FarmerDispatchWizard initialStep={1} showCardHeader={true} />

      {/* 3. Side-by-Side Comparison: Mandi vs Khet2Tech */}
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600 font-semibold mt-0.5">
                  {t.totalForLotPrefix} {formatINR(cropLot.quantityKg)} kg: ₹{formatINR(currentMandiPayout)}
                </div>
              </div>
          ...
          {/* Option B: The Khet2Tech Smart Route */}
          <div className="bg-white rounded-3xl border-2 border-emerald-600 p-6 sm:p-8 shadow-md flex flex-col justify-between space-y-6 relative">
            <div className="absolute -top-3 right-8 bg-green-700 text-white text-[10px] font-black uppercase px-3.5 py-1 rounded-full tracking-wider shadow-xs">
              {optimal?.pathNodes[optimal.pathNodes.length - 1]?.name || 'Khet2Tech RECOMMENDED'}
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-900 font-bold mt-0.5">
                  {t.totalForLotPrefix} {formatINR(cropLot.quantityKg)} kg: ₹{formatINR(currentActualPayout)}
                </div>
              </div>
            ...
            <div className="p-3.5 bg-gradient-to-r from-green-700 to-emerald-800 text-white rounded-2xl text-center shadow-xs">
              ...
              <span className="text-xl sm:text-2xl font-black text-white font-mono">
                +₹{formatINR(totalGain)} (+{gainPercentage}%)
              </span>
            </div>
          </div>
        </div>
