    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
        ...
        <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-600 flex items-center justify-between flex-wrap gap-2">
          <span>
            💡 <strong>How Khet2Tech Uses This:</strong> The official e-NAM Modal Price (<strong>₹{enamData?.averageStateModalPricePerKg?.toFixed(2) || '26.50'}/kg</strong>) is continuously ingested as the baseline APMC benchmark for Punjab, ensuring that contract price premiums are always verified against real market auctions.
          </span>
