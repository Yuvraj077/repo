      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            The mathematical heart of Khet2Tech: Mixed-Integer Programming maximizing expected net farmer payout.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-xs">
          ...
          <div className="p-5 rounded-2xl bg-slate-900 text-white border border-slate-800 space-y-3">
            ...
            <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 font-mono text-xs text-blue-200 space-y-1 text-center font-bold">
              ...
              <div className="text-emerald-300 font-bold">Khet2Tech Fee = ₹0 (Direct Contract &amp; FPO Settlement)</div>
            </div>
            ...
            <div className="space-y-1.5 text-[11px] text-slate-300">
              ...
              <div className="flex justify-between border-b border-slate-800 pb-1">
                <span className="text-slate-400">Khet2Tech Intermediary Cut:</span>
