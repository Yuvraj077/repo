...
export const metadata: Metadata = {
  title: 'Khet2Tech — Intelligent Farm-to-Market Supply-Chain Optimization (SIH 2026)',
  description: 'Smart India Hackathon 2026 (SIH26033) — KHET2TECH — Find the route that earns the farmer more.',
};
