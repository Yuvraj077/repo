...
export const TRANSLATIONS: Record<Language, AppTranslations> = {
  en: {
    ...
    heroDesc: "Multiple intermediaries reduce farmers earnings and increase consumer prices. Khet2Tech calculates the smartest, highest-earning trade route for Indian farmers by connecting them directly to food processors and bulk buyers with zero commission.",
    ...
    whereToSellDesc: "See the exact financial difference between selling at the traditional mandi vs taking the Khet2Tech recommended direct route.",
    ...
    optionBTitle: "Option B: The Khet2Tech Route",
    ...
    solverOutputTitle: "Khet2Tech Recommended:",
  ...
  hi: {
    ...
    heroDesc: "बिचौलियों के कारण किसान की कमाई घटती है और उपभोक्ता के लिए दाम बढ़ते हैं। Khet2Tech भारतीय किसानों के लिए सबसे मुनाफ़ेदार व्यापारिक रास्ता खोजता है—सीधे फ़ूड फ़ैक्ट्री और थोक खरीदारों से जोड़कर 0% कमीशन पर।",
    ...
    whereToSellDesc: "पारंपरिक APMC मंडी और Khet2Tech द्वारा सुझाई गई सीधी सड़क के बीच मुनाफ़े का सीधा अंतर देखें।",
    ...
    optionBTitle: "विकल्प B: Khet2Tech समझदार मार्ग",
    ...
    solverOutputTitle: "Khet2Tech अनुशंसित मार्ग:",
  ...
  pa: {
    ...
    heroDesc: "ਵਿਚੋਲਿਆਂ ਕਰਕੇ ਕਿਸਾਨ ਦੀ ਕਮਾਈ ਘੱਟਦੀ ਹੈ ਅਤੇ ਗਾਹਕ ਲਈ ਭਾਅ ਵੱਧਦੇ ਹਨ। Khet2Tech ਪੰਜਾਬ ਦੇ ਕਿਸਾਨਾਂ ਲਈ ਸਭ ਤੋਂ ਵੱਧ ਮੁਨਾਫ਼ੇ ਵਾਲਾ ਰਸਤਾ ਲੱਭਦਾ ਹੈ—ਸਿੱਧਾ ਪ੍ਰੋਸੈਸਿੰਗ ਪਲਾਂਟਾਂ ਅਤੇ ਥੋਕ ਖਰੀਦਦਾਰਾਂ ਨਾਲ ਜੋੜ ਕੇ ਬਿਨਾਂ ਕਿਸੇ ਆੜ੍ਹਤ ਦੇ।",
    ...
    whereToSellDesc: "ਰਵਾਇਤੀ ਦਾਣਾ ਮੰਡੀ ਅਤੇ Khet2Tech ਦੇ ਸਹੀ ਰਸਤੇ ਵਿਚਕਾਰ ਕਮਾਈ ਦਾ ਅਸਲ ਫ਼ਰਕ ਦੇਖੋ।",
    ...
    optionBTitle: "ਵਿਕਲਪ B: Khet2Tech ਸਮਝਦਾਰ ਰਸਤਾ",
    ...
    solverOutputTitle: "Khet2Tech ਦਾ ਸਹੀ ਰਸਤਾ:",
